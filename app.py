...
roastlog = pd.read_csv("https://raw.githubusercontent.com/DuaneIndustries/BCMProjectCashFlow/refs/heads/main/BCMCashflowTimelinev5527.csv")
...
def update_figure(selected_x_value):
    ...
    figx.update_layout(barmode='overlay',
                       title='Project Budget v Actuals by Category',
                       title_x=0.5,
